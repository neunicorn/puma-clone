...
import SocialMediaWrapper from "@/components/atom/SocialMediaWrapper";
import Image from "next/image";
import Logo from "@/assets/images/puma.svg";

const Footer = () => {
  return (
    <footer className="bg-secondary pt-24 pb-12 mx-auto">
      <div className="container mx-auto">
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
            ...
            <h2 className="font-bold text-4xl text-white mb-5">Nasya</h2>
            <h3 className="font-bold text-2xl mb-2">Contact Us</h3>
            <p>nasya@nasyacoorporate.com</p>
            <p>Jl. Ahmad Yani 1 No. 31B</p>
            <p>Kab. Badung, Bali</p>
          </div>
        ...
        <div className="w-full pt-10 border-t border-slate-700">
          <div className="flex item-center justify-center mb-5">
            ...
            <SocialMediaWrapper>
              <Link href="https://github.com/neunicorn">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  width="20"
            ...
            <SocialMediaWrapper>
              <Link href="https://linkedin.com/muhamadzulfan">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
